 ...
 * 2026-09-03, thread on packages/db/src/queries/identity.ts:41 — the previous implementation
 * was `'m' + b64urlEncode(bidderId)`, which is trivially reversed with `atob(slug.slice(1))` and
 * recovers the bare ЕИК; this commit closes that hole.
 *
