...
| [0036](0036-privacy-masking.md) | `noindex` + маскиране на естествено-личностни идентификатори в машинно-четим изход (Issue #173, PR #183) | Прието |
| [0037](0037-centralized-x-robots-tag-worker.md) | Централизирано авторство на `X-Robots-Tag: noindex` в worker-а (маркерният договор; refactor на PR #183) | Прието |
