...
- **Виж също:** [ADR-0003](adr/0003-centralized-x-robots-tag-worker.md) — инженерното решение за централизирано авторство на `X-Robots-Tag: noindex` в worker-а (рефакторът от PR #183 review) и [`docs/privacy-masking.md`](privacy-masking.md) за оперативно ръководство.
