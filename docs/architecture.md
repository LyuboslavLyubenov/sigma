...
идентификатори в машинно-четим изход (0033)](adr/0036-privacy-masking.md) и
[централизирано авторство на `X-Robots-Tag: noindex` в worker-а (0034)](adr/0037-centralized-x-robots-tag-worker.md).
